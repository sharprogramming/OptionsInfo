...
//    private static final Logger LOGGER = LoggerFactory.getLogger(com.studerw.tda.client.OauthInterceptor.class);
    final protected SharprogrammingTDAClient client;
    ...
    public OauthInterceptor(SharprogrammingTDAClient client, Properties properties) {
        this.client = client;
...
//        .add(AuthToken.ACCESS_TYPE_PARAM, "offline")
        ...
        HttpUrl url = this.client.getBaseURL()
